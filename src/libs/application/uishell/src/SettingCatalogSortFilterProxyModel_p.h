#ifndef UISHELL_SETTINGCATALOGSORTFILTERPROXYMODEL_H
#define UISHELL_SETTINGCATALOGSORTFILTERPROXYMODEL_H
...
#endif //UISHELL_SETTINGCATALOGSORTFILTERPROXYMODEL_H
