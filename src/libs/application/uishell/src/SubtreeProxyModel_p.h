#ifndef UISHELL_SUBTREEPROXYMODEL_P_H
#define UISHELL_SUBTREEPROXYMODEL_P_H
...
namespace UIShell {
    ...
    class SubtreeProxyModel : public QAbstractProxyModel {
        Q_OBJECT
        Q_PROPERTY(QModelIndex rootIndex READ rootIndex WRITE setRootIndex NOTIFY rootIndexChanged)
    public:
        explicit SubtreeProxyModel(QObject *parent = nullptr);
        virtual ~SubtreeProxyModel() override;
...
#endif //UISHELL_SUBTREEPROXYMODEL_P_H
