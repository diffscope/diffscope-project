...
namespace dspx {
    ...
    class NoteSequencePrivate : public RangeSequenceData<NoteSequence, Note, &Note::pos, &Note::posChanged, &Note::length, &Note::lengthChanged, &NotePrivate::setOverlapped> {
