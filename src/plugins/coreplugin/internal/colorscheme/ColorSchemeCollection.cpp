...
namespace Core::Internal {
    ...
    static QList<QPair<QString, QVariantHash>> m_internalPresets{
        ...
        {QT_TRANSLATE_NOOP("Core::Internal::ColorSchemeCollection", "DiffScope Light"),
         {
            {"accentColor", QVariant::fromValue(QColor::fromRgb(0x6b7aff))},
            {"warningColor", QVariant::fromValue(QColor::fromRgb(0xcb8743))},
            {"errorColor", QVariant::fromValue(QColor::fromRgb(0xcc4455))},
            {"buttonColor", QVariant::fromValue(QColor::fromRgb(0xcdcfd4))},
            {"textFieldColor", QVariant::fromValue(QColor::fromRgb(0xf5f6f8))},
            {"scrollBarColor", QVariant::fromValue(QColor::fromRgba(0x4f4f4f7f))},
            {"borderColor", QVariant::fromValue(QColor::fromRgb(0xa6a8ad))},
            {"backgroundPrimaryColor", QVariant::fromValue(QColor::fromRgb(0xeceef2))},
            {"backgroundSecondaryColor", QVariant::fromValue(QColor::fromRgb(0xf0f1f6))},
            {"backgroundTertiaryColor", QVariant::fromValue(QColor::fromRgb(0xf4f5fa))},
            {"backgroundQuaternaryColor", QVariant::fromValue(QColor::fromRgb(0xf8faff))},
            {"splitterColor", QVariant::fromValue(QColor::fromRgb(0xc4c6cb))},
            {"paneSeparatorColor", QVariant::fromValue(QColor::fromRgb(0xcdced3))},
            {"foregroundPrimaryColor", QVariant::fromValue(QColor::fromRgb(0x050608))},
            {"foregroundSecondaryColor", QVariant::fromValue(QColor::fromRgba(0xa0050608))},
            {"linkColor", QVariant::fromValue(QColor::fromRgb(0x5566ff))},
            {"navigationColor", QVariant::fromValue(QColor::fromRgb(0x050608))},
            {"shadowColor", QVariant::fromValue(QColor::fromRgb(0x202226))},
            {"highlightColor", QVariant::fromValue(QColor::fromRgb(0xa07a00))},
            {"flatButtonHighContrastBorderColor", QVariant::fromValue(QColor(Qt::transparent))},
            {"controlDisabledColorChange", QVariant::fromValue(SVS::ColorChange{SVS::TopBlendColorFilter{QColor::fromRgba(0x33ffffff)}})},
            {"foregroundDisabledColorChange", QVariant::fromValue(SVS::ColorChange{SVS::AlphaColorFilter{0.5}})},
            {"controlHoveredColorChange", QVariant::fromValue(SVS::ColorChange{SVS::TopBlendColorFilter{QColor::fromRgba(0x18000000)}})},
            {"foregroundHoveredColorChange", QVariant::fromValue(SVS::ColorChange{})},
            {"controlPressedColorChange", QVariant::fromValue(SVS::ColorChange{})},
            {"foregroundPressedColorChange", QVariant::fromValue(SVS::ColorChange{SVS::AlphaColorFilter{0.8}})},
            {"controlCheckedColorChange", QVariant::fromValue(SVS::ColorChange{SVS::TopBlendColorFilter{QColor::fromRgba(0x18000000)}})},
            {"annotationPopupTitleColorChange", QVariant::fromValue(SVS::ColorChange{SVS::AlphaColorFilter{0.72}, SVS::BottomBlendColorFilter{0xeceef2}})},
            {"annotationPopupContentColorChange", QVariant::fromValue(SVS::ColorChange{SVS::AlphaColorFilter{0.16}, SVS::BottomBlendColorFilter{0xeceef2}})},
            {"dockingPanelHeaderActiveColorChange", QVariant::fromValue(SVS::ColorChange{SVS::TopBlendColorFilter{QColor::fromRgba(0x3f6b7aff)}})},
            {"trackColorSchema0", QVariant::fromValue(QColor::fromRgb(0x6b7aff))},
            {"trackColorSchema1", QVariant::fromValue(QColor::fromRgb(0x9e66f2))},
            {"trackColorSchema2", QVariant::fromValue(QColor::fromRgb(0xc257ce))},
            {"trackColorSchema3", QVariant::fromValue(QColor::fromRgb(0xd258a1))},
            {"trackColorSchema4", QVariant::fromValue(QColor::fromRgb(0xda5b68))},
            {"trackColorSchema5", QVariant::fromValue(QColor::fromRgb(0xba794e))},
            {"trackColorSchema6", QVariant::fromValue(QColor::fromRgb(0x968e3f))},
            {"trackColorSchema7", QVariant::fromValue(QColor::fromRgb(0x759940))},
            {"trackColorSchema8", QVariant::fromValue(QColor::fromRgb(0x4da244))},
            {"trackColorSchema9", QVariant::fromValue(QColor::fromRgb(0x43a069))},
            {"trackColorSchema10", QVariant::fromValue(QColor::fromRgb(0x429c93))},
            {"trackColorSchema11", QVariant::fromValue(QColor::fromRgb(0x5093bf))},
            {"loopColor", QVariant::fromValue(QColor::fromRgb(0xcc7f00))},
            {"levelMeterColor", QVariant::fromValue(QColor::fromRgb(0xc9cbd1))},
            {"editAreaPrimaryColor", QVariant::fromValue(QColor::fromRgb(0xd4d6dc))},
            {"editAreaSecondaryColor", QVariant::fromValue(QColor::fromRgb(0xe4e6eb))},
            {"editAreaPrimaryHighlightColor", QVariant::fromValue(QColor::fromRgb(0xc9cfef))},
            {"editAreaSecondaryHighlightColor", QVariant::fromValue(QColor::fromRgb(0xd5daf4))},
            {"playheadPrimaryColor", QVariant::fromValue(QColor::fromRgb(0xcc4455))},
            {"playheadSecondaryColor", QVariant::fromValue(QColor::fromRgba(0x7fcc4455))},
            {"cursorIndicatorColor", QVariant::fromValue(QColor::fromRgba(0xbf007399))},
            {"scissorIndicatorColor", QVariant::fromValue(QColor::fromRgb(0xcc4455))},
            {"scalePrimaryColor", QVariant::fromValue(QColor::fromRgb(0xffffff))},
            {"scaleSecondaryColor", QVariant::fromValue(QColor::fromRgba(0xbfffffff))},
            {"scaleTertiaryColor", QVariant::fromValue(QColor::fromRgba(0x7fffffff))},
            ...
            {"clipMuteColor", QVariant::fromValue(QColor::fromRgb(0x7c7c7c))},
            {"whiteKeyColor", QVariant::fromValue(QColor::fromRgb(0xffffff))},
            {"blackKeyColor", QVariant::fromValue(QColor::fromRgb(0x1f2124))},
            {"whiteKeyTextColor", QVariant::fromValue(QColor::fromRgb(0x202226))},
            {"blackKeyTextColor", QVariant::fromValue(QColor::fromRgb(0xdadada))},
            {"itemSelectedColorChange", QVariant::fromValue(SVS::ColorChange{SVS::TopBlendColorFilter{QColor::fromRgba(0x11000000)}})},
            {"clipSelectedColorChange", QVariant::fromValue(SVS::ColorChange{SVS::OkLabLighterColorChange{1.2}})},
            {"clipThumbnailColorChange", QVariant::fromValue(SVS::ColorChange{SVS::AlphaColorFilter{0.5}})},
            {"noteSelectedColorChange", QVariant::fromValue(SVS::ColorChange{SVS::OkLabLighterColorChange{1.2}})},
         }},
