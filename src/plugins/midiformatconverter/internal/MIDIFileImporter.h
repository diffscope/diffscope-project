#ifndef DIFFSCOPE_MIDI_FORMAT_CONVERTER_MIDIFILEIMPORTER_H
#define DIFFSCOPE_MIDI_FORMAT_CONVERTER_MIDIFILEIMPORTER_H
...
#endif //DIFFSCOPE_MIDI_FORMAT_CONVERTER_MIDIFILEIMPORTER_H
