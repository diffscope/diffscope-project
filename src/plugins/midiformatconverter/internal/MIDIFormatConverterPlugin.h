#ifndef DIFFSCOPE_MIDI_FORMAT_CONVERTER_MIDIFORMATCONVERTERPLUGIN_H
#define DIFFSCOPE_MIDI_FORMAT_CONVERTER_MIDIFORMATCONVERTERPLUGIN_H
...
#endif //DIFFSCOPE_MIDI_FORMAT_CONVERTER_MIDIFORMATCONVERTERPLUGIN_H
