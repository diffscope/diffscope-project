...
ActionCollection {
    ...
    ActionItem {
        actionId: "org.diffscope.visualeditor.arrangementPanel.snapDurationCommand"
        Action {
            id: commandAction
            readonly property Menu menu: Menu {
                id: menu
                title: commandAction.text
                Instantiator {
                    model: DelegateModel {
                        model: [
            ...
            onTriggered: Qt.callLater(() => d.addOn.windowHandle.execQuickPick(menu))
        }
    }

    ActionItem {
        actionId: "org.diffscope.visualeditor.arrangementPanel.snapTupletCommand"
        Action {
            id: commandAction
            readonly property Menu menu: Menu {
                id: menu
