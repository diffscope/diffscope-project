...
namespace Synth::Internal {
    ...
    bool SynthesisAudioController::prepare(Core::ProjectWindowInterface *window, dspx::SingingClip *clip, SynthesisPiece *piece, QPointer<Audio::TrackAudioContext> &trackContext, talcs::FutureAudioSourceClipSeries *&series, QString *errorMessage) {
        if (!clip || !piece || piece->singingClip() != clip) {
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("The synthesis piece is no longer available");
            }
            return false;
        }
        ...
        if (!currentTrackContext || !projectAudioContext || !projectAudioContext->transport()) {
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("The project audio context is not available");
            }
            return false;
        }
        ...
        if (!series) {
            ...
            if (!currentTrackContext->trackMixer()->addSource(series)) {
                ...
                series = nullptr;
                if (errorMessage) {
                    *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("Synthesized audio for the synthesis piece could not be added to the track");
                }
                return false;
            }
        ...
        if (!range.isValid()) {
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("The synthesis piece is outside the visible range of its clip");
            }
            return false;
        }
        ...
        if (!clipView.isValid()) {
            ...
            promise->finish();
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("The synthesis piece overlaps another synthesis piece in the same clip");
            }
            return false;
        }
    ...
    bool SynthesisAudioController::install(Core::ProjectWindowInterface *window, dspx::SingingClip *clip, SynthesisPiece *piece, QPointer<Audio::TrackAudioContext> &trackContext, talcs::FutureAudioSourceClipSeries *&series, const QString &filePath, QString *errorMessage) {
        ...
        if (!binding || !binding->futureSource || !binding->promise || binding->futureSource->source()) {
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("The synthesis piece is no longer waiting for synthesized audio");
            }
            return false;
        }
        ...
        if (!io) {
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("The synthesized audio file could not be opened");
            }
            return false;
        }
        ...
        if (!mixer->addSource(source)) {
            ...
            delete source;
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("Synthesized audio for the synthesis piece could not be prepared");
            }
            return false;
        }
    ...
    bool SynthesisAudioController::refreshRange(Core::ProjectWindowInterface *window, dspx::SingingClip *clip, SynthesisPiece *piece, Audio::TrackAudioContext *trackContext, talcs::FutureAudioSourceClipSeries *series, double sampleRate, QString *errorMessage) {
        ...
        if (!series->setClipRange(binding->clip, range.position, range.length)) {
            if (errorMessage) {
                *errorMessage = Synth::Internal::SynthesisProjectAddOn::tr("Synthesized audio for the synthesis piece could not be repositioned");
            }
            return false;
        }
