...
&lt;p&gt;Please note that the DiffScope development team &lt;b&gt;does not guarantee&lt;/b&gt; that the report will not be disclosed to third parties. It is your decision whether to send the report.&lt;/p&gt;
      ...
      <translation>&lt;p&gt;诊断报告可能包含&lt;b&gt;敏感信息&lt;/b&gt;（例如用户名、主机名、网络地址、个性化配置）。&lt;/p&gt;
&lt;p&gt;如果你不希望公开此类信息，请&lt;b&gt;不要&lt;/b&gt;在 GitHub Issues 或在线聊天室等公共平台上分享此报告。&lt;/p&gt;
&lt;p&gt;你可以按照反馈指南，通过电子邮件私密地将报告发送给 DiffScope 开发团队。&lt;/p&gt;
&lt;p&gt;请注意，DiffScope 开发团队&lt;b&gt;不保证&lt;/b&gt;该报告不会被泄露给第三方。你应当自行决定是否发送该报告。&lt;/p&gt;
</translation>
    </message>
    <message>
